...
| [从基础到流畅-衔接路线.md](./从基础到流畅-衔接路线.md) | 从基础补强接续到《流畅的 Python》精读：阶段 0~4 时间轴、原书章节×基础前置映射表、三遍读法、验收闸门与里程碑 |
| [流畅的Python_第2章_序列_学习讲义.docx](./流畅的Python_第2章_序列_学习讲义.docx) | 外部材料（WorkBuddy 生成）：《流畅的 Python》第 2 章序列专题讲义 Word 版，含配图与 40 分自测，衔接路线的阶段 2 使用 |
...
> 重测时建议加 `--shuffle` 打乱题目与选项顺序，避免靠记忆作答：`python quiz.py --shuffle`
